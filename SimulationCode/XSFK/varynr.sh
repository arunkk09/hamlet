...
time python gendata-xsfk.py $ds $dr 0.0625 1 $rgvar $nl $1
echo "$ds $dr 0.25 4 $rgvar $nl $1"
time python gendata-xsfk.py $ds $dr 0.25 4 $rgvar $nl $1
echo "$ds $dr 0.5 10 $rgvar $nl $1"
time python gendata-xsfk.py $ds $dr 0.5 10 $rgvar $nl $1
