...
pt = proc.time();
outset = myffs(allfeatsjcnofk, 1, YRtrain, YRtest, 'RMSE');
print(proc.time() - pt)
...
pt = proc.time();
outset = mybfs(allfeatsjcnofk, 1, YRtrain, YRtest, 'RMSE');
print(proc.time() - pt)
...
pt = proc.time();
outset = myfilter(sfmijcnofk, "stars", YRtrain, YRtest, 'RMSE');
print(proc.time() - pt)
...
pt = proc.time();
outset = myfilter(sfigrjcnofk, "stars", YRtrain, YRtest, 'RMSE');
print(proc.time() - pt)
