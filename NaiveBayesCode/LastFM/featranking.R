...
sfmijcnoartist = intersect(sortedfeatsmi, allfeatsjcnoartist)
sfigrjcnoartist = intersect(sortedfeatsigr, allfeatsjcnoartist)
...
print(sfigrca)
print("JCnoartist features sorted by MI")
print(sfmijcnoartist)
print("JCnoartist features sorted by IGR")
print(sfigrjcnoartist)
...
pt = proc.time();
outset = myfilter(sortedfeatsmi, "plays", LFtrain, LFtest, 'RMSE');
print(proc.time() - pt)
...
pt = proc.time();
outset = myfilter(sortedfeatsigr, "plays", LFtrain, LFtest, 'RMSE');
print(proc.time() - pt)
...
print("Running Filter-MI for JCnoartist on 5 classes")
pt = proc.time();
outset = myfilter(sfmijcnoartist, "plays", LFtrain, LFtest, 'RMSE');
print(proc.time() - pt)
print("Finished Filter-MI for JCnoartist on 5 classes")
print("Hold out validation")
pt = proc.time(); outsettr = myNBlog(LFtrain[,outset], LFtrain[,"plays"], laplace=1); print(proc.time() - pt)
pt = proc.time(); outsettab = table(predict.myNBlog(outsettr, LFhold[,outset]), LFhold[,"plays"], dnn=list('predicted','actual')); print(proc.time() - pt)
print("Holdout validation of outset of Filter-MI for JCnoartist")
acc = geterr(outsettab, 'RMSE', nrow(LFhold), nrow(outsettab))
print(acc)
print("Running Filter-IGR for JCnoartist on 5 classes")
pt = proc.time();
outset = myfilter(sfigrjcnoartist, "plays", LFtrain, LFtest, 'RMSE');
print(proc.time() - pt)
print("Finished Filter-IGR for JCnoartist on 5 classes")
print("Hold out validation")
pt = proc.time(); outsettr = myNBlog(LFtrain[,outset], LFtrain[,"plays"], laplace=1); print(proc.time() - pt)
pt = proc.time(); outsettab = table(predict.myNBlog(outsettr, LFhold[,outset]), LFhold[,"plays"], dnn=list('predicted','actual')); print(proc.time() - pt)
print("Holdout validation of outset of Filter-IGR for JCnoartist")
acc = geterr(outsettab, 'RMSE', nrow(LFhold), nrow(outsettab))
print(acc)

print("Running Filter-MI for JCnouser on 5 classes")
pt = proc.time();
outset = myfilter(sfmijcnouser, "plays", LFtrain, LFtest, 'RMSE');
print(proc.time() - pt)
...
pt = proc.time();
outset = myfilter(sfigrjcnouser, "plays", LFtrain, LFtest, 'RMSE');
print(proc.time() - pt)
...
pt = proc.time();
outset = myfilter(sfmica, "plays", LFtrain, LFtest, 'RMSE');
print(proc.time() - pt)
...
pt = proc.time();
outset = myfilter(sfigrca, "plays", LFtrain, LFtest, 'RMSE');
print(proc.time() - pt)
